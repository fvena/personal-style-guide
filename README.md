...
| **Vue.js 3 Project**  | `eslint/vue`                                       | `prettier/vue`  | `stylelint/vue`  | Use official `@vue/tsconfig` |
| **Nuxt.js 4 Project** | `eslint/nuxt`                                      | `prettier/nuxt` | `stylelint/nuxt` | Auto-generated by Nuxt       |
...
- For Vue.js projects: `npm install --save-dev vue`
