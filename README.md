...
| **Vue.js 3 Project**  | `eslint/vue`                                       | `prettier/vue`  | `stylelint/vue`  | `vitest/vue`  | Use official `@vue/tsconfig` |
| **Nuxt.js 4 Project** | `eslint/nuxt`                                      | `prettier/nuxt` | `stylelint/nuxt` | `vitest/nuxt` | Auto-generated by Nuxt       |
