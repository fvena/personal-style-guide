...
The easiest way to get started is with the factory function that automatically detects your project setup:
...
import { quickSetup } from 'personal-style-guide'
export default quickSetup()

// Minimal configuration (base rules only)
import { minimal } from 'personal-style-guide'
export default minimal()
```

### Prerequisites

ESLint, Prettier, Stylelint, Typescript are peer dependencies:
...
The factory function automatically detects your project setup and applies the appropriate configurations:
...
**Alternative: Individual Configurations**

You can also use individual configurations for fine-grained control:
